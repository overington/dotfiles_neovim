...
nmap <leader>cln  <Plug>(coc-codelens-action)
...
let g:nvm_default_version = readfile(expand("~/.nvm/alias/default"))[0]
let g:coc_node_path = expand("~/.nvm/versions/node/v" . g:nvm_default_version . "/bin/node")
